...
// These tokens are used throughout the component system for consistency
...
export const getColor = (scale: ColorScale, shade: ColorShade = 500) => {
  return designTokens.colors[scale][shade];
};
